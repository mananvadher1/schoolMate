                ...
                <form class="my-4" action="subject.php?id=" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="edit_sub_ref" name="edit_sub_ref" placeholder="Enter Reference Link">
                        </div>
                    </div>
    ...
    <div>
        <div class="collapse mt-3" id="collapseExample">
            <form class="form-inline" method="post" action="subject.php">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label class="form-label mx-2" for="sub_ref">Enter Reference</label>
                    <input type="text" class="form-control" id="sub_ref" name="sub_ref" placeholder="Enter Reference Link">
                </div>
